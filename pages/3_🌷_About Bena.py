...
with col2:
    st.write("I am especially excited about creating AI agents. At Gallo Winery, I created a LangChain AI agent to ask questions about Gallo’s wine sales in plain language. \
